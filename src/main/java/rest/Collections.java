...
//      response.setHeader("Access-Control-Allow-Origin", "*");
        ...
        String collection_name = String.valueOf(formInput.getFirst("collection_name"));
        String collection_genre = String.valueOf(formInput.getFirst("collection_genre"));
        String collection_cover = String.valueOf(formInput.getFirst("collection_cover"));
        String collection_note = String.valueOf(formInput.getFirst("collection_note"));
...
//      response.setHeader("Access-Control-Allow-Origin", "*");
        ...
        return DB.toJson(DB.getInstance().getDataRoll("SELECT collection_name, collection_genre, collection_cover, collection_note FROM collections WHERE collections.user_id ='" + user_id + "'"));
    }
...
//      response.setHeader("Access-Control-Allow-Origin", "*");
        String user_id = session.getAttribute(session_id, "user_id");
        System.out.println("--|_O‿O_|--  " + collection_id);
        String collection_name = String.valueOf(formInput.getFirst("collection_name"));
        String collection_genre = String.valueOf(formInput.getFirst("collection_genre"));
        String collection_cover = String.valueOf(formInput.getFirst("collection_cover"));
        String collection_note = String.valueOf(formInput.getFirst("collection_note"));
